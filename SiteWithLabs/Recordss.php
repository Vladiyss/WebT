	...
	<div class="intro__container">
		<div class="intro__inner">
			<section class="intro__section">
				<img class="records__image" src="images/scyscrapers0.jpg" align="left" vspace="5" hspace="5" alt="">
				<a class="rec__link" href="#">Самые высокие здания и сооружения</a>
				<p class="rec__text">blablabla</p>
			</section>
			<section class="intro__section">
				<img class="records__image" src="images/cold0.jpg" align="left" vspace="5" hspace="5" alt="">
				<a class="rec__link" href="#">Самые холодные места планеты</a>
				<p class="rec__text">blablabla</p>
			</section>
			<section class="intro__section">
				<img class="records__image" src="images/hot0.jpg" align="left" vspace="5" hspace="5" alt="">
				<a class="rec__link" href="Records_Hott.php">Самые жаркие места планеты</a>
				<p class="rec__text">blablabla</p>
			</section>
		</div>
