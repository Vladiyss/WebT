...
--
-- Хост: localhost
-- Время создания: Май 09 2020 г., 10:03
...
(1, 'Vlad', 'Kasheuski', '+375293345379', 'kpachbiyy@gmail.com'),
(2, 'Zakhar', 'Youshkevich', '+37529563153', 'zakharyanton@gmail.com');
...
INSERT INTO `site` (`user_ID`, `login`, `password`) VALUES
(1, 'cookie', '$2y$10$7lyyrWYPD72zaM/6ES8LOeUYhFe9Yd6vpxHNhb0NnXlLpkxus68Fm'),
(2, 'cookie', '$2y$10$AqoqOid.C27TCcK5SV8poeqpQVwUh6kV/J4DaQ.gWuz2BEsSdu1UG'),
(3, 'fun', '$2y$10$SS/Hj24d75KC843d45aSVOK.vyqYbTEtzjoi9U/ZOJuOBESlQ5TTC'),
(4, 'Vlad', '$2y$10$UuxPGsmDWp0qs6qgHkU1SOrEpxQU7G3JzD0BSMwAYyhyFpGkJ.yXK');
...
INSERT INTO `site_users` (`visitor_ID`, `IP_address`, `visits_number`) VALUES
(1, '::1', 6),
(2, '192.168.43.21', 7);
...
--
ALTER TABLE `site_users`
  MODIFY `visitor_ID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
COMMIT;
