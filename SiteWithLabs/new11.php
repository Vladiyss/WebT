...
<head>
	<meta  charset="utf-8">
	<title>РЕКОРДЫ</title>
	<link rel="stylesheet" href="./new1css.css" type="text/css" />
	...
	<div class="intro__container">
		<div class="intro__inner">
			<section class="intro__section">
				<h1>Рекорды встречаются повсеместно в нашей жизни!</h1>
				<article class="intro__article">
					<h2>Рекорды - наивысший успех, достижение в какой-либо области труда,
					хозяйства, спорта и т. п.; в переносном смысле — любые крайние значения измеримых величин.
					Также используется термин "Высшее мировое достижение".</h2>
				</article>
			</section>
		</div>
